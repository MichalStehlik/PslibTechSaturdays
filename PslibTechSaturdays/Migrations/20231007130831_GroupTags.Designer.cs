...
namespace PslibTechSaturdays.Migrations
{
    ...
    [Migration("20231007130831_GroupTags")]
            ...
            modelBuilder.Entity("PslibTechSaturdays.Models.Action", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ActionId = 1,
                            Active = true,
                            Created = new DateTime(2023, 10, 7, 15, 8, 31, 26, DateTimeKind.Local).AddTicks(258),
            ...
            modelBuilder.Entity("PslibTechSaturdays.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Aspirant = false,
                            ConcurrencyStamp = "ebfa7733-fc69-4713-9753-b3334456486f",
                            Created = new DateTime(2023, 10, 7, 15, 8, 30, 988, DateTimeKind.Local).AddTicks(2830),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEIO/IeWQGtUEDFwhaQ+HC7UF6guxsZN7JxTHKuQ30Z1i4h9utGLpB0AiywK2VvVxmQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "G56SBMMYFYXDNGIMOS5RMZUDSTQ4BQHI",
                            TwoFactorEnabled = false,
                            Updated = new DateTime(2023, 10, 7, 15, 8, 30, 988, DateTimeKind.Local).AddTicks(2883),
            ...
            modelBuilder.Entity("PslibTechSaturdays.Models.Group", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ActionId = 1,
                            Capacity = 5,
                            Created = new DateTime(2023, 10, 7, 15, 8, 31, 26, DateTimeKind.Local).AddTicks(333),
                            CreatedById = new Guid("11111111-1111-1111-1111-111111111111"),
                        ...
                        new
                        {
                            ...
                            ActionId = 1,
                            Capacity = 10,
                            Created = new DateTime(2023, 10, 7, 15, 8, 31, 26, DateTimeKind.Local).AddTicks(343),
                            CreatedById = new Guid("11111111-1111-1111-1111-111111111111"),
